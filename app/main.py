...
from app.shamir.sharing import PlaintextToHexSecretSharer
...
friend1Addr = "http://tenzorum1-regio.c9users.io:8080/"
friend2Addr = "http://tenzorum2-regio.c9users.io:8080/"
friend3Addr = "http://tenzorum3-regio.c9users.io:8080/"
...
def getShamirPiece(tan, usr, friendId):
    ...
    url = "http://tenzorum" + str(friendId) + "-regio.c9users.io:8080/getSecret"
    friendId = friendId + 1
